...
const Room = () => {
  ...
  return (
    <div>
      ...
      <div>
        <video className='camera-feed' ref={userVideoRef} id="video" autoPlay hidden></video>
        <Canvas style={{ height: 600 }} camera={{ fov: 25 }} shadows gl={{ gammaInput: true, gammaOutput: true }}>
